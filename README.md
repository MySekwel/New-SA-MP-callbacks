...
[![sampctl](https://img.shields.io/badge/sampctl-New--SA--MP--callbacks-2f2f2f.svg?style=for-the-badge)](https://github.com/MySekwel/New-SA-MP-callbacks)
...
```bash
sampctl package install MySekwel/New-SA-MP-callbacks
```
